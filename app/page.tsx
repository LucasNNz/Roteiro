...
export default function Home() {
  ...
  return <main className="app-shell">
    ...
    <footer><span>CORVOQUIZ PRODUÇÃO <i>V0.6.29</i></span><span>DIAGNÓSTICO DO ANALISTA · CHECKPOINT PRESERVADO · V0.6.29</span></footer>
    ...
    {settingsOpen && <div className="modal-backdrop" onMouseDown={(event)=>event.target===event.currentTarget&&setSettingsOpen(false)}><section className="settings-modal">
      ...
      <section className="downloads-section" aria-labelledby="downloads-title">
        ...
        <div className="download-grid">
          ...
          <a className="download-card" href="/downloads/CORVO_BRIDGE_V0616_EXTENSION.zip" download><span>↗</span><div><b>EXTENSÃO DO BRIDGE</b><small>CORVO BRIDGE V0.6.16 · DIAGNÓSTICO COMPLETO DO ENVIO AO ANALISTA</small></div><i>↓</i></a>
          <a className="download-card featured" href="/downloads/CORVOQUIZ_KIT_COMPLETO_V0629.zip" download><span>◆</span><div><b>KIT COMPLETO CORVOQUIZ</b><small>APP + EXTENSÕES + SCHEMA</small></div><i>↓</i></a>
        </div>
      </section>
